...
# ============================================================
# innovus_3d_final-re.tcl
# Final metric extraction with routed-database restore fallback.
# ============================================================
...
# Stage handoff
set stage_name "final-restore"
# Inputs : 5_route.def / 5_route.v / 5_route.sdc / ${DESIGN}_postRoute.enc.dat
# Outputs: 6_final.png / final_metrics.csv / final_summary.txt / handoffs/final-restore.tcl
...
handoff_write_manifest $stage_paths -extra_kv [list csv_out $CSV_OUT summary_out $SUMMARY_OUT mode postRoute_restore]
