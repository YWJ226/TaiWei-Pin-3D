...
# ============================================================
# innovus_place3D_init_bottom.tcl
# Run bottom-tier incremental place initialization.
# ============================================================
...
set requested_allow_net [_normalize_allow_net_class "bottom-only"]
set effective_allow_net [_effective_allow_net_class $requested_allow_net]
_report_allow_net_resolution "place-init-bottom" $requested_allow_net $effective_allow_net
apply_tier_policy bottom -fixlib 1 -allow_net $effective_allow_net

pc::setup_basic
pc::run_global_place_step place_init_bottom
...
puts "INFO: 3D bottom tier incremental init done. DEF: [handoff_get $stage_paths def_out]  V: [handoff_get $stage_paths v_out]"
