...
# Receive-tier postCTS optimization stage for staged 3D CTS.
# ============================================================
...
# Stage handoff
set stage_name "receive-opt"
# Inputs : 4_0_cts_owner_tree.def / 4_0_cts_owner_tree.v / 4_0_cts_owner_tree.sdc
# Outputs: 4_1_cts_receive_opt.def / 4_1_cts_receive_opt.v / 4_1_cts_receive_opt.sdc
...
_report_allow_net_resolution "cts-receive-opt" $requested_allow_net $effective_allow_net
...
extract_cross_tier_nets [file join $LOG_DIR "cts_receive_opt.before.nets"] -clock_only 1
...
optDesign -postCTS -outDir $REPORTS_DIR -prefix cts_receive_opt

set_tier_placement_status $fixed_tier placed
extract_cross_tier_nets [file join $LOG_DIR "cts_receive_opt.after.nets"] -clock_only 1
