...
# ============================================================
# innovus_place3D_init.tcl
# Bootstrap 3D place initialization.
# ============================================================
...
puts "INFO: 3D bottom tier bootstrap place init done. DEF: [handoff_get $stage_paths def_out]  V: [handoff_get $stage_paths v_out]"
